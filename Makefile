...
#     NO_META => q[1]
#     PL_FILES => {  }
#     PREREQ_PM => { File::Spec=>q[0], File::Temp=>q[0], ExtUtils::MakeMaker=>q[6.17], File::Path=>q[0] }
#     VERSION => q[0.03]
...
ppd:
	...
	$(NOECHO) $(ECHO) '        <DEPENDENCY NAME="ExtUtils-MakeMaker" VERSION="6,17,0,0" />' >> $(DISTNAME).ppd
